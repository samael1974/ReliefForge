@echo off
title ReliefForge 8.6 - Creazione setup .exe (NON CHIUDERE questa finestra)
cd /d "%~dp0"
if exist build_ok.txt del build_ok.txt

echo ============================================================
echo   ReliefForge 8.6 - compilazione completa + SETUP .EXE
...
echo   release\ReliefForge-Setup-8.6.0.exe
echo ============================================================
echo.
