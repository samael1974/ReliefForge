...
2. Scarica `ReliefForge-Setup-8.4.0.exe`.
...
1. Dalla pagina **Releases** scarica il `.dmg` per il tuo Mac: `ReliefForge-8.4.0-mac-arm64.dmg` (chip Apple M1/M2/M3/M4) oppure `ReliefForge-8.4.0-mac-x64.dmg` (Mac Intel).
...
- Mesh parametrica (profili Bilanciato / Fine / Massima) con dimensioni reali in mm e decimazione.
- Cornice e passepartout parametrici con battuta vetro e alloggiamento LED.
...
L'installer viene creato in `release\ReliefForge-Setup-8.4.0.exe`.
