...
2. Scarica `ReliefForge-Setup-8.6.0.exe`.
...
1. Dalla pagina **Releases** scarica il `.dmg` per il tuo Mac: `ReliefForge-8.6.0-mac-arm64.dmg` (chip Apple M1/M2/M3/M4) oppure `ReliefForge-8.6.0-mac-x64.dmg` (Mac Intel).
...
L'installer viene creato in `release\ReliefForge-Setup-8.6.0.exe`.
